...
hike_data <- readr::read_rds(url('https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-11-24/hike_data.rds'))
...
Data <-read.xlsx("MVM_productallocation.xlsx")
kable(Data) %>%
